...
Sub InitUI_A09_Buff(root As xui.Element Ptr)
	UI_Buff_LayoutList = xui.CreateElement(XUI_LAYOUT_RULER_RATIO, 0, 0, 2, 1, XUI_LAYOUT_T2B, "UI_TileSet_LayoutList")
	UI_Buff_LayoutInfo = xui.CreateFrame(XUI_LAYOUT_RULER_RATIO, 0, 0, 7, 1, XUI_LAYOUT_L2R, "状态编辑", "UI_TileSet_LayoutInfo")
	UI_Buff_LayoutList->Layout.RectBox.LeftOffset = 6
	UI_Buff_LayoutList->Layout.RectBox.TopOffset = 6
	UI_Buff_LayoutList->Layout.RectBox.BottomOffset = 6
	UI_Buff_LayoutInfo->Layout.RectBox.LeftOffset = 6
	UI_Buff_LayoutInfo->Layout.RectBox.RightOffset = 6
	UI_Buff_LayoutInfo->Layout.RectBox.TopOffset = 6
