...
Sub InitUI_A06_Armor(root As xui.Element Ptr)
	UI_Armor_LayoutList = xui.CreateElement(XUI_LAYOUT_RULER_RATIO, 6, 6, 2, 1, XUI_LAYOUT_T2B, "UI_TileSet_LayoutList")
	UI_Armor_LayoutInfo = xui.CreateFrame(XUI_LAYOUT_RULER_RATIO, 6, 6, 7, 1, XUI_LAYOUT_L2R, "防具编辑", "UI_TileSet_LayoutInfo")
