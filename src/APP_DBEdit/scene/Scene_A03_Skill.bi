...
Sub InitUI_A03_Skill(root As xui.Element Ptr)
	UI_Skill_LayoutList = xui.CreateElement(XUI_LAYOUT_RULER_RATIO, 0, 0, 2, 1, XUI_LAYOUT_T2B, "UI_TileSet_LayoutList")
	UI_Skill_LayoutInfo = xui.CreateFrame(XUI_LAYOUT_RULER_RATIO, 0, 0, 7, 1, XUI_LAYOUT_L2R, "技能编辑", "UI_TileSet_LayoutInfo")
	UI_Skill_LayoutList->Layout.RectBox.LeftOffset = 6
	UI_Skill_LayoutList->Layout.RectBox.TopOffset = 6
	UI_Skill_LayoutList->Layout.RectBox.BottomOffset = 6
	UI_Skill_LayoutInfo->Layout.RectBox.LeftOffset = 6
	UI_Skill_LayoutInfo->Layout.RectBox.RightOffset = 6
	UI_Skill_LayoutInfo->Layout.RectBox.TopOffset = 6
